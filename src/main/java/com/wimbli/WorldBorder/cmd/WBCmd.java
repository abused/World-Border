...
public abstract class WBCmd
{
    ...
    public final static String C_CMD  = TextFormatting.AQUA.toString();			// main commands
    public final static String C_DESC = TextFormatting.WHITE.toString();		// command descriptions
    public final static String C_ERR  = TextFormatting.RED.toString();			// errors / notices
    public final static String C_HEAD = TextFormatting.YELLOW.toString();		// command listing header
    public final static String C_OPT  = TextFormatting.DARK_GREEN.toString();	// optional values
    public final static String C_REQ  = TextFormatting.GREEN.toString();		// required values
